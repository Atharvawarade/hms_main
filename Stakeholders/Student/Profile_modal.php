    ...
    <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-head" id="fullname-display"><?php echo $student['Fullname']; ?></h5>
                    <p class="card-text"><strong>EN : </strong><span id="en-display"><?php echo $student['EN']; ?></span></p>
                    <p class="card-text"><strong>Email : </strong><span id="email-display"><?php echo $student['email']; ?></span></p>
                    <p class="card-text"><strong>Room No. : </strong><span id="room-display"><?php echo $student['room_id']; ?></span></p>
                    <button id="edit-btn" class="btn btn-primary mt-3" onclick="toggleEdit()">Edit</button>
                </div>
            </div>
                    </div>
