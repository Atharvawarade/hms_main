    ...
    <div class="about_container">
      ...
      <div class="about-content-container">
        <div class="row about_row">
          ...
          <div
            class="col-md-6 text_row d-flex justify-content-center align-items-center"
          >
        ...
        <div class="row about_row">
          <div
            class="col-md-6 text_row d-flex justify-content-center align-items-center order-lg-1 order-md-2"
          >
            <div class="text_container">
              <h4>Girls Hostel</h4>
              <p>
          ...
          <div
            class="col-md-6 image_row d-flex justify-content-center align-items-center order-lg-2 order-md-1"
          >
            <div class="image_container">
        ...
        <div class="row">
          <div class="col-6 col-md-3">
            <div class="promise-box">
              ...
              <p>Your safety is our top priority. Our hostel is equipped with 24/7 surveillance, secure access controls, and a dedicated security team to ensure a safe and secure environment for all residents.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="promise-box">
              ...
              <p>Enjoy the comfort of our well-furnished rooms and modern amenities. Each room is designed to provide a cozy and convenient living space.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="promise-box">
              ...
              <p>Relish healthy and delicious meals prepared by our experienced chefs. We cater to diverse dietary needs, ensuring that every meal is balanced, nutritious, and hygienically prepared.</p>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="promise-box">
              <img
                src="../assets/employee-engagement.png"
                alt="Personal Growth and Community"
              />
            ...
            <div class="vacancy_box">
              ...
              <div class="square_box">
                <div class="inside_square_box">
                  <div
                    class="progressdiv"
                    data-percent="<?php echo $percentage_hostel_1; ?>"
                  >
                    <svg
                      class="progress"
                      width="178"
            ...
            <div class="vacancy_box">
              ...
              <div class="square_box">
                <div class="inside_square_box">
                  <div
                    class="progressdiv"
                    data-percent="<?php echo $percentage_hostel_2; ?>"
                  >
                    <svg
                      class="progress"
                      width="178"
